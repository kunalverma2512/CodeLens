...
export default function Hero() {
  return (
    <section className="w-full flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20 bg-white">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-8 w-full">
        <Link
          to="/dashboard"
          className="w-full sm:w-auto px-12 py-6 bg-black text-white text-xl font-black uppercase tracking-widest hover:bg-gray-900 transition-colors border-4 border-black"
        >
          Start Building
        </Link>
        ...
        <Link
          to="/explore"
          className="w-full sm:w-auto px-12 py-6 bg-white text-black text-xl font-black uppercase tracking-widest hover:bg-gray-100 transition-colors border-4 border-black"
        >
          Explore Platform
        </Link>
      </div>
