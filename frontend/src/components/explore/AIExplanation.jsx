export default function AIExplanation() {
  return (
    <div className="w-full px-6 py-20 md:py-32 min-h-screen flex flex-col justify-center items-center border-b-4 border-black bg-black text-white">
      <div className="max-w-5xl mx-auto w-full text-center">
        ...
        <div className="inline-block border-4 border-white px-8 sm:px-12 py-6 font-black uppercase tracking-widest text-xl sm:text-3xl shadow-[8px_8px_0_0_rgba(200,200,200,1)] md:shadow-[12px_12px_0_0_rgba(200,200,200,1)]">
