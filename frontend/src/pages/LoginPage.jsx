    ...
    <div className="w-full flex-1 flex flex-col items-center justify-center px-8 py-20 bg-white">
      <div className="w-full max-w-md border-[4px] border-black p-12 bg-white shadow-[16px_16px_0_0_rgba(0,0,0,1)]">
        ...
        <form className="flex flex-col space-y-8">
          ...
          <button 
            type="submit" 
            className="w-full mt-4 py-6 bg-black text-white text-xl font-black uppercase tracking-widest hover:bg-gray-900 transition-colors border-[4px] border-black rounded-none"
          >
            Sign In
          </button>
        </form>
